...
6.一些说明
/v1/images/generations（DALL-E）兼容接口必须使用非流式解析，注意apikey填写a1111_path的值（即设置页面中的“A1111 接口安全子路径”），
stable diffusion（A1111）兼容接口地址则为“http://你的服务所部署的机器的ip:你设置的端口号/你填写的子路径”，
例如http://192.168.1.3:8029/mytestpath
